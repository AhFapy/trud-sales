...
const Works = () => {
  ...
  const faqs = [
    { 
      ...
      answer: 'Te hago yo la pregunta: ¿por qué seguir buscando si tienes aquí la solución?<br/><br/>Y si no la tienes es porque tienes dudas, ¿verdad?<br/><br/>Rellena este <a href="https://app.trudsales.com/trabaja-con-nosotros" target="_blank" style="text-decoration: underline; color: #00FF00; font-weight: 500;">formulario</a> y nos pondremos en contacto contigo para resolverte las dudas que tengas.' 
    },
    { 
    ...
    { 
      ...
      answer: 'Somos muy selectivos con nuestros clientes. Nos gusta trabajar con proyectos, poner nuestra energía en ellos y escalarlos, mirando siempre el largo plazo más que el corto.<br/><br/>De todos modos, si crees que lo que ofrecemos puede ayudarte o resolver una necesidad actual tuya o de tu empresa, puedes rellenar <a href="https://app.trudsales.com/trabaja-con-nosotros" target="_blank" style="text-decoration: underline; color: #00FF00;">este formulario</a>.'
    },
    { 
      question: '¿Qué experiencia tiene Trud Sales?', 
      answer: 'Trud Sales nace de una necesidad.<br/><br/>Una necesidad de abarcar más proyectos y ayudar a más personas a cerrar sus ventas.<br/><br/>En 2024 facturamos +1.500.000 para nuestros clientes entre los fundadores, y esperamos poder duplicarlo mínimamente este año.<br/><br/>No deberías haber entrado en “experiencia” para ver con quién hemos trabajado, sino hacerte la pregunta: ¿realmente pueden ayudarme?<br/><br/>Si la respuesta es sí, rellena el formulario de aquí abajo.<br/><br/>Si la respuesta es no, probablemente tengas dudas. En ese caso, <a href="https://app.trudsales.com/trabaja-con-nosotros" target="_blank" style="text-decoration: underline; color: #00FF00;">rellena este formulario</a> y te las resolvemos.' 
    },
    { 
    ...
    { 
      ...
      answer: 'Facilísimo:<br/><br/>1. Rellena <a href="https://app.trudsales.com/trabaja-con-nosotros" target="_blank" style="text-decoration: underline; color: #00FF00;">este formulario</a><br/>2. Nos pondremos en contacto para que tengas una sesión de auditoría con nosotros (sí, gratuita).<br/>3. Si concuerda con nuestra visión y valores de marca, te daremos un sí o un no.<br/>4. Lo demás tendrás que descubrirlo.' 
    },
    { 
      question: 'Quiero formarme como Appt. Setter o Closer', 
      answer: 'Nuestro foco está en fluir desde la naturalidad, sin scripts de ventas absurdos. Si quieres apuntarte a la lista prioritaria, puedes postularte <a href="https://app.trudsales.com/formate-con-nosotros" target="_blank" style="text-decoration: underline; color: #00FF00;">aquí</a>' 
    }
  ];
